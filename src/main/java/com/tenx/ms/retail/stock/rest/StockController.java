...
public class StockController {
    ...
    public void addOrUpdate(
            @ApiParam( name = "storeId" ) @PathVariable Long storeId,
            @ApiParam( name = "productId" ) @PathVariable Long productId,
            @ApiParam( name = "count", value = "fields for creating store", required = true ) @RequestBody @Validated Stock stock) {
